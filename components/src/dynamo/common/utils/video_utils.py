...
"""Shared video encoding utilities.

This module provides utilities for converting PIL images to numpy arrays
and encoding numpy video frames to MP4 format (on disk or in memory).
"""
