...
func (in *DynamoGraphDeploymentSpec) DeepCopyInto(out *DynamoGraphDeploymentSpec) {
	*out = *in
	...
	if in.TrafficProxy != nil {
		in, out := &in.TrafficProxy, &out.TrafficProxy
		*out = new(TrafficProxySpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrafficProxySpec) DeepCopyInto(out *TrafficProxySpec) {
	*out = *in
	if in.Replicas != nil {
		in, out := &in.Replicas, &out.Replicas
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrafficProxySpec.
func (in *TrafficProxySpec) DeepCopy() *TrafficProxySpec {
	if in == nil {
		return nil
	}
	out := new(TrafficProxySpec)
